package com.vehiclecare.vc_driver.activity
...
import com.vehiclecare.vc_driver.utils.AppSharedPreference
...
//            startActivity(Intent(this, IntroLandingScreen::class.java)).also { finish() }
        }
    }
}